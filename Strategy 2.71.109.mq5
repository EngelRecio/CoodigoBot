//+------------------------------------------------------------------+
//| Strategy 2.71.109 EA
//|
//|    Generated by StrategyQuant X Build 140 for MetaTrader5 (netted)
//|    Generated at 10/07/2024 01:27
//| 
//|    Backtested on EURUSD_M1,GBPUSD_M1,USDJPY_M1,AAPL,USDCHF_M1 / H4, 2010.01.01 - 2022.04.06 
//+------------------------------------------------------------------+
...
input string CustomComment = "Strategy_2_71_109";
...
input int LinRegPeriod1 = 30;        //LinRegPeriod1
input int ATRLowerPeriod1 = 20;        //ATRLowerPeriod1
input int LinRegPeriod2 = 50;        //LinRegPeriod2
input int ATRLowerPeriod2 = 14;        //ATRLowerPeriod2
input int ExitAfterBars1 = 8;        //ExitAfterBars1
...
input string SignalTimeRangeFrom = "03:00";
...
input int MinimumSL = 30;   //Minimum SL in pips
input int MinimumPT = 60;   //Minimum PT in pips
input int MaximumSL = 80;   //Maximum SL in pips
input int MaximumPT = 200;   //Maximum PT in pips
...
input string Subchart1Symbol = "GBPUSD_M1";
input int Subchart1Timeframe = 240;
input double Subchart1TickSizeSQ = 1.0E-4; //Subchart1PipSizeSQ
input string Subchart2Symbol = "USDJPY_M1";
input int Subchart2Timeframe = 240;
input double Subchart2TickSizeSQ = 0.01; //Subchart2PipSizeSQ
input string Subchart3Symbol = "AAPL";
input int Subchart3Timeframe = 240;
input double Subchart3TickSizeSQ = 0.01; //Subchart3PipSizeSQ
input string Subchart4Symbol = "USDCHF_M1";
input int Subchart4Timeframe = 240;
input double Subchart4TickSizeSQ = 1.0E-4; //Subchart4PipSizeSQ
...
#define LINEARREGRESSION_1 0     //iCustom(correctSymbol(Subchart4Symbol),TFMigrate(Subchart4Timeframe), "SqLinReg", LinRegPeriod1, PRICE_CLOSE)
#define ATR_1 1     //iCustom(correctSymbol(Subchart4Symbol),TFMigrate(Subchart4Timeframe), "SqATR", ATRLowerPeriod1)
#define LINEARREGRESSION_2 2     //iCustom(correctSymbol(Subchart4Symbol),TFMigrate(Subchart4Timeframe), "SqLinReg", LinRegPeriod2, PRICE_CLOSE)
#define ATR_2 3     //iCustom(correctSymbol(Subchart4Symbol),TFMigrate(Subchart4Timeframe), "SqATR", ATRLowerPeriod2)
#define PARABOLICSAR_1 4     //iCustom(NULL,0, "SqParabolicSAR", 0.010, 0.10)
#define PARABOLICSAR_2 5     //iCustom(NULL,0, "SqParabolicSAR", 0.01, 0.1)
#define HEIKENASHI_1 6     //255
#define HEIKENASHI_2 7     //255
#define HEIKENASHI_3 8     //255
#define HEIKENASHI_4 9     //255
#define HEIKENASHI_5 10     //255
...
string sqStrategyName = "Strategy 2.71.109";
...
if (_sqIsBarOpen == true) {
     ...
     LongEntrySignal = ((((sqIsFalling(LINEARREGRESSION_1, 2, false, 2)
      &&   sqGetIndicatorValue(ATR_1, 1) < 60.01)
      &&   sqIsFalling(LINEARREGRESSION_1, 2, false, 3))
      &&   sqIsFalling(LINEARREGRESSION_2, 2, false, 2))
      &&   sqGetIndicatorValue(ATR_2, 3) < 0.01);

     ShortEntrySignal = ((((sqIsRising(LINEARREGRESSION_1, 2, false, 2)
      &&   sqGetIndicatorValue(ATR_1, 1) < 60.01)
      &&   sqIsRising(LINEARREGRESSION_1, 2, false, 3))
      &&   sqIsRising(LINEARREGRESSION_2, 2, false, 2))
      &&   sqGetIndicatorValue(ATR_2, 3) < 0.01);
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqGetIndicatorValue(PARABOLICSAR_1, 0, 3), "Current");
...
//------------------------
...
)
   {
      // Action #1
        // Enter at Stop
      openPrice = sqFixMarketPrice(sqGetIndicatorValue(PARABOLICSAR_2, 0, 3), "Current");
      ...
      size = sqMMRiskFixedAccountPct("Current",ORDER_TYPE_SELL_STOP,openPrice,sl,mmRiskPercent,mmDecimals,mmStopLossPips,mmLotsIfNoMM,mmMaxLots,mmMultiplier,mmStep);
...
int OnInit(){
   ...
   SymbolSelect(correctSymbol(Subchart1Symbol), true);        
   SymbolSelect(correctSymbol(Subchart2Symbol), true);        
   SymbolSelect(correctSymbol(Subchart3Symbol), true);        
   SymbolSelect(correctSymbol(Subchart4Symbol), true);        
...
bool initIndicators(){
   ...
   indicatorHandles[LINEARREGRESSION_1] = iCustom(correctSymbol(Subchart4Symbol),TFMigrate(Subchart4Timeframe), "SqLinReg", LinRegPeriod1, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_1] = iCustom(correctSymbol(Subchart4Symbol),TFMigrate(Subchart4Timeframe), "SqATR", ATRLowerPeriod1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[LINEARREGRESSION_2] = iCustom(correctSymbol(Subchart4Symbol),TFMigrate(Subchart4Timeframe), "SqLinReg", LinRegPeriod2, PRICE_CLOSE);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[ATR_2] = iCustom(correctSymbol(Subchart4Symbol),TFMigrate(Subchart4Timeframe), "SqATR", ATRLowerPeriod2);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[PARABOLICSAR_1] = iCustom(NULL,0, "SqParabolicSAR", 0.010, 0.10);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[PARABOLICSAR_2] = iCustom(NULL,0, "SqParabolicSAR", 0.01, 0.1);
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HEIKENASHI_1] = 255;
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HEIKENASHI_2] = 255;
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HEIKENASHI_3] = 255;
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HEIKENASHI_4] = 255;
   
   ArrayResize(indicatorHandles, ArraySize(indicatorHandles) + 1, 10);
   indicatorHandles[HEIKENASHI_5] = 255;
...
uchar getHeikenAshiIndex(string symbol, ENUM_TIMEFRAMES timeframe){
   ...
   if(symbol == Symbol() && (timeframe == Period() || timeframe == 0)){
      ...
      if(symbol == correctSymbol(Subchart1Symbol) && timeframe == TFMigrate(Subchart1Timeframe)){
         return HEIKENASHI_2;
      }
      if(symbol == correctSymbol(Subchart2Symbol) && timeframe == TFMigrate(Subchart2Timeframe)){
         return HEIKENASHI_3;
      }
      if(symbol == correctSymbol(Subchart3Symbol) && timeframe == TFMigrate(Subchart3Timeframe)){
         return HEIKENASHI_4;
      }
      if(symbol == correctSymbol(Subchart4Symbol) && timeframe == TFMigrate(Subchart4Timeframe)){
         return HEIKENASHI_5;
      }
   }
...
double sqGetMarketTickSize(string symbol){
   ...
   symbol = correctSymbol(symbol);
      ...
      if(symbol == correctSymbol(Subchart1Symbol)){
         return Subchart1TickSizeSQ;
      }
    
      if(symbol == correctSymbol(Subchart2Symbol)){
         return Subchart2TickSizeSQ;
      }
    
      if(symbol == correctSymbol(Subchart3Symbol)){
         return Subchart3TickSizeSQ;
      }
    
      if(symbol == correctSymbol(Subchart4Symbol)){
         return Subchart4TickSizeSQ;
      }
...
string correctSymbol(string symbol){
    ...
    else if (symbol == "Subchart3Symbol") return correctSymbol(Subchart3Symbol);
    else if (symbol == "Subchart4Symbol") return correctSymbol(Subchart4Symbol);
    else return symbol;
}
